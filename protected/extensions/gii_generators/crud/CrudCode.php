...
class CrudCode extends CCodeModel
{
    ...
    public $model;
    public $controller;
    public $baseControllerClass = 'BaseAdminController';
    private $_modelClass;
    private $_table;
    public $crudPath = 'application';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), array(
                    ...
                    array('crudPath', 'validateCrudPath', 'skipOnError' => true),
    ...
    public function validateCrudPath($attribute, $params)
    {
        if (Yii::getPathOfAlias($this->crudPath) === false)
            $this->addError('crudPath', 'Crud Path must be a valid path alias.');
    }
    ...
    public function getControllerFile()
    {
        ...
        return Yii::getPathOfAlias($this->crudPath . '.controllers') . '/' . $id . 'Controller.php';
    }


    public function getViewPath()
    {
        return Yii::getPathOfAlias($this->crudPath . '.views') . '/' . $this->getControllerID();
    }
    ...
    public function generateActiveField($modelClass, $column)
    {
        ...
        else
        {
            ...
            return "\$form->{$inputField}(\$model,'{$column->name}',array('class' => 'span7'))";
        }
    }
